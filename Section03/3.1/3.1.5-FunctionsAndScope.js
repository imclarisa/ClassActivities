...
function parentAndChildScope() {
  ...
  console.log("Parent Scope, Child Variable:", childVariable); // This console.log statement will not print because it cannot reference the variable childVariable due to it being scoped inside another function in the parent scope.
                                                                // A parent scope cannot reference variables from a child scope
}
parentAndChildScope();
}
